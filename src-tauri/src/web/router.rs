...
pub fn build_router(
    ...
    let api = Router::new()
        ...
        .route(
            ...
            post(handlers::session_search::search_session_content),
        )
        .route(
        ...
        .route(
            "/get_session_collaboration_settings",
            post(handlers::collaboration::get_settings),
        )
        .route(
            "/set_session_collaboration_settings",
            post(handlers::collaboration::set_settings),
        )
        .route(
        ...
        .route(
            "/conversation_set_launch_preferences",
            post(handlers::acp::conversation_set_launch_preferences),
        )
